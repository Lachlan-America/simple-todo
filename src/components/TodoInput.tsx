    ...
    return (
        <form onSubmit={handleSubmit} className="flex gap-2">
            <input
                ...
                className="flex-1 hover:border hover:border-white focus:border-white active:border-white transition-all border 
                border-transparent duration-200 p-2 rounded-xl bg-[#232223]"
            />
            <button
                type="submit"
